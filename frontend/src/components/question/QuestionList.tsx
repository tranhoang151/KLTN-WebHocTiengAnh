...
const QuestionList: React.FC<QuestionListProps> = ({
  ...
  // Bulk status update removed - all questions are active by default
  ...
  const handleDuplicateQuestion = (question: Question) => {
    ...
    if (onEditQuestion) {
      onEditQuestion(duplicatedQuestion);
    }
    setShowDetailDialog(false);
  };

  const getCourseName = (question: Question) => {
    // Support both old (course_id) and new (courseId) field names
    const courseId = question.course_id || question.courseId;
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        >
          ...
          >
            ...
            {/* Status Filter */}
            {/* Status filter removed - all questions are active by default */}
          </div>
        </div>
        ...
        {selectedQuestions.size > 0 && (
          ...
          >
            ...
            >
              ...
              >
                {/* Status bulk actions removed - all questions are active by default */}
                <button
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Status badge removed - all questions are active by default */}
                    </div>
                  </div>
                  ...
                  <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    >
                              ...
                              {question.options.map((option, index) => (
                                <div
                                  ...
                                  style={{
                                    ...
                                    fontWeight: '500',
                                    background:
                                      index === parseInt(question.correctAnswer?.toString() || '0')
                                    ...
                                    color:
                                      index === parseInt(question.correctAnswer?.toString() || '0')
                                        ? '#065f46'
                                        : '#374151',
                                    border: `1px solid ${index === parseInt(question.correctAnswer?.toString() || '0') ? '#10b981' : '#d1d5db'}`,
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '6px',
                                  }}
                      ...
                      {question.type === 'true_false' && (
                        ...
                        >
                          ...
                          <span
                            style={{
                              padding: '4px 8px',
                              background: question.correctAnswer
                                ? 'linear-gradient(135deg, #d1fae5, #a7f3d0)'
                                : 'linear-gradient(135deg, #fee2e2, #fecaca)',
                              color: question.correctAnswer ? '#065f46' : '#991b1b',
                              borderRadius: '6px',
                              fontSize: '12px',
                              fontWeight: '600',
                              border: question.correctAnswer
                                ? '1px solid #10b981'
                                : '1px solid #ef4444',
                            }}
                          >
                      ...
                      {question.type === 'essay' && (
                        ...
                        >
                          <FileText size={14} color="#10b981" style={{ marginTop: '2px' }} />
                          <div style={{ flex: 1 }}>
                            <span
                              style={{
                                fontSize: '13px',
                    ...
                    {showActions && (
                      ...
                      >
                        ...
                        >
                          {/* Detail button removed - click on card to view details */}
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
        ...
        {showDetailDialog && selectedQuestion && (
          <QuestionDetailDialog
            question={selectedQuestion}
            course={courses.find(c => c.id === (selectedQuestion.course_id || selectedQuestion.courseId)) || null}
